...
<body>
				...
				<tfoot>
					...
					<tr>
						<td colspan="2" style="text-align: right;">
							<input type="submit" value="댓글작성" onclick="comm_insert2()">
						...
						<tr style="border: 1px solid #aaa;">
							<td  style="padding: 15px;">${k.writer}(${k.write_date})<br>
								...
								<form action="/comm_delete2" method="post" style="">
									...
									<input type="hidden" name="b_idx" value="${bvo.b_idx }">
									<input type="hidden" name="cPage" value="${cPage}">
									<input type="submit" value="댓글삭제" onclick="comm_delete2()">
	...
	function comm_delete2(){
		// 갈곳, 파라미터, 성공했을 때 function()
		$.post("/comm_delete2", {email:$("#email").val()}, function (response) {
			if(response === "success"){
				alert("인증코드가 전송되었습니다.");
			}else{
				alert("전송실패");
	...
	function comm_insert2() {
		$.post("/comm_insert2()", {code:$("#code").val()}, function (response) {
