 ...
 * Generated at: 2025-04-11 07:53:47 UTC
...
public final class ajax01Form_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("</head>\r\n");
      out.write("<body>\r\n");
      out.write("	<h2>기상청_단기예보(구_동네예보) 조회서비스 - 단기 예보 조회(서울)</h2>\r\n");
      out.write("	\r\n");
      ...
      out.write("			\r\n");
      out.write("			\r\n");
      out.write("			$(\"#result\").html(\"<p>XML 데이터 로딩 중 ... </p>\");\r\n");
      out.write("			$.ajax({\r\n");
      out.write("				\r\n");
      out.write("				url: \"/weatherXml\",\r\n");
      ...
      out.write("						let date = $(this).find(\"fcstDate\").text()\r\n");
      out.write("						let time = $(this).find(\"fcstTime\").text()\r\n");
      out.write("						let category = $(this).find(\"category\").text()\r\n");
      out.write("						let fcstValue = $(this).find(\"fcstValue\").text()\r\n");
      out.write("						\r\n");
      out.write("						\r\n");
      out.write("						let label = weatherExplain[category]?.label || category;\r\n");
      out.write("						let desc = weatherExplain[category]?.interpret(fcstValue) || \"-\"; \r\n");
      out.write("						\r\n");
      out.write("						\r\n");
      out.write("						table += \"<tr>\";\r\n");
      out.write("						table += \"<td>\" + date +\"</td>\";\r\n");
      out.write("						table += \"<td>\" + time +\"</td>\";\r\n");
      out.write("						table += \"<td>\" + category +\"</td>\";\r\n");
      out.write("						table += \"<td>\" + fcstValue +\"</td>\";\r\n");
      out.write("						table += \"<td>\" + label +\"</td>\";\r\n");
      ...
      out.write("			$(\"#result\").html(\"<p>JSON 데이터 로딩 중 ... </p>\");\r\n");
      out.write("			$.ajax({\r\n");
      out.write("				\r\n");
      out.write("				url: \"/weatherJson\",\r\n");
      out.write("				method:\"POST\",\r\n");
      ...
      out.write("						\r\n");
      out.write("						let date = v.fcstDate;\r\n");
      out.write("						let time = v.fcstTime;\r\n");
      out.write("						let category = v.category;\r\n");
      out.write("						let fcstValue = v.fcstValue;\r\n");
      out.write("						\r\n");
      out.write("						let label = weatherExplain[category]?.label || category;\r\n");
      out.write("						let desc = weatherExplain[category]?.interpret(fcstValue) || \"-\"; \r\n");
      out.write("						\r\n");
